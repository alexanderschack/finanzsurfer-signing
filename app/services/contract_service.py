...
def render_contract_html(
    ...
    # Adapt print CSS to web CSS
    css_replacements = {
        # Page layout: A4 fixed → flowing web
        "width: 210mm;": "max-width: 800px;",
        "min-height: 297mm;": "",
        "page-break-after: always;": "",
        "padding: 45mm 30mm 35mm 30mm;": "padding: 40px 30px 30px 30px;",
        "@page {\n    size: A4;\n    margin: 0;\n  }\n  ": "",
        "-webkit-print-color-adjust: exact;\n    print-color-adjust: exact;\n": "",
        # Cover
        "padding-top: 60mm;": "padding-top: 80px; padding-bottom: 60px; min-height: 400px;",
        # Logo
        "top: 25mm;\n    left: 30mm;\n    height: 28mm;": "top: 20px;\n    left: 20px;\n    height: 50px;",
        # Page logo
        "position: absolute;\n    top: 20mm;\n    left: 30mm;\n    height: 20mm;": "height: 36px; margin-bottom: 16px;",
        # Cover footer
        "position: absolute;\n    bottom: 25mm;\n    left: 30mm;": "position: relative; margin-top: 30px;",
        # Page numbers
        "position: absolute;\n    bottom: 20mm;\n    right: 30mm;": "text-align: right; margin-top: 16px; padding-top: 8px; border-top: 0.5pt solid rgba(141,95,78,0.2);",
        # mm units to px
        "margin-bottom: 15mm;": "margin-bottom: 30px;",
        "margin-bottom: 20mm;": "margin-bottom: 30px;",
        "margin-top: 15mm;": "margin-top: 25px;",
        "margin-bottom: 5mm;": "margin-bottom: 8px;",
        ...
        # Remove print/screen media queries
    ...
    # Remove from CTA through closing div
    import re
    html = re.sub(
